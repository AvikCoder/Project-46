...
function setup() {
  ...
  obstacle5 = new Obstacle(1190,350,10,1000,'yellow');
  obstacle6 = new Obstacle(10,350,10,1000,"yellow")

  moving1 = new Moving(600,320,200,20);
...
if(collision1.collided){
  Matter.Body.setVelocity(moving1.body,{x:-15,y:0});
}
//console.log(collision2.collided);
